            ...
            <header className={styles.TopBar}>
                ...
                <div className={styles.TopContainer}>
                    ...
                    <div className={styles.GitWrap}>
                        <a href='https://github.com/runxaway' target="_blank" rel="noreferrer" className={styles.GitIcon}>
            ...
            <div className={styles.Bottom}>
                    ...
                    <div className={styles.Learn}>
                        ...
                        <div className={styles.LearnRow}>
                            <img
                                ...
                                src={StarBlack}
                            />
                            <a href="https://threejs.org/" target="_blank" rel="noreferrer" className={styles.RowTitle}>three.js</a>
                        </div>
                        <div className={styles.LearnRow}>
                            <img
                                className={styles.StarBlack}
                                src={StarBlack}
                            />
                            <a href="https://p5js.org/" target="_blank" rel="noreferrer" className={styles.RowTitle}>p5.js</a>
                        </div>
                    </div>
                </div>
                <div
                ...
                <div className={styles.ExpWrapper}>
                    ...
                    <h2 className={styles.ExpText}>
                        ...
                        <a href="https://vibelab.etu.ru/" target="_blank" rel="noreferrer" className={styles.VibeLab}>VibeLab</a>.
